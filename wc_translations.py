...
TRANSLATIONS = {
    "Japanese": {
        ...
        "later_button": "あとで",
        "restart_now_button": "再起動して更新",
        "cancel_button": "キャンセル",
        "downloading_update": "更新をダウンロード中...",
        "update_ready_msg": "更新の準備ができました。WildCatcher を終了して更新を適用し、自動的に再起動します。",
        "update_install_failed": "更新を自動でインストールできませんでした。手動でダウンロードすることもできます。",
    ...
    "Spanish": {
        ...
        "downloading_update": "Descargando la actualización...",
        "update_ready_msg": "La actualización está lista. WildCatcher se cerrará, la instalará y volverá a abrirse automáticamente.",
        "update_install_failed": "No se pudo instalar la actualización automáticamente. Puedes descargarla manualmente.",
    ...
    "Chinese": {
        ...
        "download_button": "下载",
        "update_now_button": "立即更新",
        "later_button": "稍后",
        "restart_now_button": "立即重启",
        "cancel_button": "取消",
        "downloading_update": "正在下载更新...",
        "update_ready_msg": "更新已准备就绪。WildCatcher 将关闭、安装更新并自动重新打开。",
        "update_install_failed": "无法自动安装更新。您可以手动下载。",
    ...
    "English": {
        ...
        "update_ready_msg": "The update is ready. WildCatcher will close, install it and reopen automatically.",
        "update_install_failed": "The update could not be installed automatically. You can download it manually instead.",
    ...
    "Korean": {
        ...
        "update_now_button": "지금 업데이트",
        "later_button": "나중에",
        "restart_now_button": "지금 다시 시작",
        "cancel_button": "취소",
        "downloading_update": "업데이트 다운로드 중...",
        "update_ready_msg": "업데이트가 준비되었습니다. WildCatcher가 종료된 뒤 설치하고 자동으로 다시 열립니다.",
        "update_install_failed": "업데이트를 자동으로 설치하지 못했습니다. 수동으로 내려받을 수 있습니다.",
